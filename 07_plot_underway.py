...
axs[4].set_ylabel("Salinity") #MF comment: pasa todas las labels a inglés e incluye unidades.
axs[4].grid(True)
...
axs[5].set_ylabel("Clorofila") #MF comment: pasa todas las labels a inglés e incluye unidades.
