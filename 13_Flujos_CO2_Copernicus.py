...
df = pd.read_excel(r"C:\Users\javil\Desktop\TFM\excel\SS7_CON_VIENTOS.xlsx")
...
df['FCO2_producto'] = df['kw_cop'] * df['SCO2'] * df['deltafCO2'] * 0.24
...
df['FCO2_cop'] = (df['FCO2_producto'] / 1000) * 365.25
...
ruta_excel = r"C:\Users\javil\Desktop\TFM\excel\SS7_CON_VIENTOS.xlsx"
